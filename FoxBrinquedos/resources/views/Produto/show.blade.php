                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Estoque: <small id="estoque">{{$produto->Estoque->PRODUTO_QTD}}</p>
                                </small>
                            ...
                            <div>
                                <button type="button" class="btn btn-custom"
                                    style="margin-left: 20px;">Adicionar</button>
                    ...
                    <div class="col">
                        <div class="cardd">
                            @if($produtoRelacionado->Imagem->isNotEmpty())
                                <a href="{{ route('produto.show', $produtoRelacionado->PRODUTO_ID) }}"><img
                                        src="{{ $produtoRelacionado->Imagem->first()->IMAGEM_URL }}" class="img-top"
                                        alt="Imagem do Produto"></a>
                            @else
                                <a href="{{ route('produto.show', $produtoRelacionado->PRODUTO_ID) }}"><img src="..."
                                        class="img-top" alt="Imagem Padrão"></a>
                            @endif
                            <div class="card-body">
                                <h5 class="card-titlee"><a
                                        href="{{ route('produto.show', $produtoRelacionado->PRODUTO_ID) }}">{{ $produtoRelacionado->PRODUTO_NOME }}</a>
                                </h5>
                                <h6 class="card-precoo">R$ {{ $produtoRelacionado->PRODUTO_PRECO }}</h6>
                                <p class="card-textt">à vista</p>
                                <a href="{{ route('produto.show', $produtoRelacionado->PRODUTO_ID) }}"><button
                                        class="btn btn-primary custom-btn" type="button">Adicionar</button></a>
                            </div>
                        </div>
                    </div>
                @endforeach
